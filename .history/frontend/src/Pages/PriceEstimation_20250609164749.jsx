...
const CurrentPriceEstimation = () => {
  ...
  useEffect(() => { 
    if (options) {
      ...
      if (!selectedBedrooms && options.bedroom_options?.length > 0) setSelectedBedrooms(String(options.bedroom_options[0].sort((a, b) => a - b)[0])); // Sort to get the lowest number
