...
const MarketSimulator = () => {
  ...
  const [selectedCity, setSelectedCity] = useState('Beirut'); // Default to Beirut
...
// useEffect(() => {
//     // Fetch data whenever the selectedCity changes
//     const fetchData = async () => {
//         // Construct the URL with the selected city
//         const apiUrl = `http://127.0.0.1:5000/api/market-scenarios?city=${selectedCity}`;
//         const response = await fetch(apiUrl);
//         const data = await response.json();
        
//         // The data formatting logic from before remains the same!
//         // ... (format data for Recharts)
//         setChartData(formattedData);
//     };

//     fetchData();
// }, [selectedCity]); // This re-runs the effect when selectedCity changes
...
//         {/* Your Recharts <LineChart> component goes here */}
//     </div>
// );