...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <section><form onSubmit={handleSubmit} style={{ /* ... your form styles are fine ... */ }}>
      ...
      {predictionData?.forecast && !isFetching && (
        <div className="results" style={{ marginTop: '20px', flex: '1', display: 'flex', borderRadius:'5px', border: '1px solid var(--background-light-gray-f)', backgroundColor: 'var(--background-light-white-p)', padding: '20px', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', boxShadow: '0px 1px 5px 1px var(--background-light-gray-p)', transition: 'transform 0.225s ease-in-out', transform: 'scale(1)' }}
