...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ arginBottom: '20px', flexDirection:'row',  display: 'flex', flexWrap: 'nowrap', gap: '15px', justifyContent:'space-evenly',alignContent:'center',alignItems: 'center', padding: '10px', border: '1px solid #ccc', borderRadius: '5px' }}>
