...
const CurrentPriceEstimation = () => {
  ...
  const  num_of_bathrooms= ["", "Baabda, Aley, Chouf", "Beirut", "Bekaa", "Kesrouan, Jbeil", "Tripoli, Akkar"];
  const num_of_bedrooms = ["", "Baabda, Aley, Chouf", "Beirut", "Bekaa", "Kesrouan, Jbeil", "Tripoli, Akkar"];
