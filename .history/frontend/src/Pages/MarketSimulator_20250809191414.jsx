...
// --- This is the required registration step for Chart.js ---
ChartJS.register(
  CategoryScale,
  LinearScale,
  PointElement,
...
const MarketSimulator = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            setError(null);
            try {
                const response = await fetch(`http://127.0.0.1:8000/v1/market-simulator?selection=${selectedCity}`);
    ...
    // --- CHART.JS DATA FORMATTING (This is the key change) ---
