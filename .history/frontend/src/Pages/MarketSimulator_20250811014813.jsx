            ...
            <div className="market-simulator-content">
                ...
                <div className="dashboard-components">
                    <div className="form-card">
                        {/* The form structure is preserved as requested */}
                        <form>
                            <div className="form-group">
                                ...
                                <select id="selectedCity" value={selectedCity} onChange={(e) => setSelectedCity(e.target.value)}>
                                    {/* A disabled "Select a City" option is good practice */}
                            ...
                            {/* This div wraps both the chart and the button */}
                            <div>
                                <div className="form-group">
                                    {/* All chart-related rendering logic is now here */}
                                    ...
                                    {/* FIX: type="button" prevents page reload */}
