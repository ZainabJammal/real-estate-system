...
const CurrentPriceEstimation = () => {
  ...
  return (
    <div className="price-estimation-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ marginBottom: '20px', paddingToppaddingBottom: '15px', paddingRight: '70px !important', paddingLeft: '20px !important', border: '1px solid #ccc', borderRadius: '5px' }}>
