...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ maxWidth:'100%',marginBottom: '20px', flexDirection:'row',  display: 'flex', flexWrap: 'nowrap', gap: '15px', jsutifyContentalignContent:'center',alignItems: 'center', padding: '10px', border: '1px solid #ccc', borderRadius: '5px' }}>
