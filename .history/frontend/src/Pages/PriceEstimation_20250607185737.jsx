...
const CurrentPriceEstimation = () => {
  ...
  useEffect(() => {
    ...
    if (options?.cities?.length > 0 && !selectedCity) setSelectedCity(options.cities[0]);
    if (options?.districts?.length > 0 && !selectedDistrict) setSelectedDistrict(options.districts[0]);
    if (options?.provinces?.length > 0 && !selectedProvince) setSelectedProvince(options.provinces[0]);
  ...
  }, [options, selectedCity, selectedDistrict, selectedProvince, selectedType, selectedBedrooms, selectedBathrooms]);
...
const CurrentPriceEstimation = () => {
  const predefinedLoction = ["", "Baabda, Aley, Chouf", "Beirut", "Bekaa", "Kesrouan, Jbeil", "Tripoli, Akkar"];
  const  num_of_bath= ["", "Baabda, Aley, Chouf", "Beirut", "Bekaa", "Kesrouan, Jbeil", "Tripoli, Akkar"];
  const num_of_bed = ["", "Baabda, Aley, Chouf", "Beirut", "Bekaa", "Kesrouan, Jbeil", "Tripoli, Akkar"];
  const size_m2 = ["", "Baabda, Aley, Chouf", "Beirut", "Bekaa", "Kesrouan, Jbeil", "Tripoli, Akkar"];
  const type_of_properties = [];
   


  const [selectedCity, setSelectedCity] = useState(predefinedLocation[0]);
