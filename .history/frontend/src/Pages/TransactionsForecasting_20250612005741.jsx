...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" >
      <div><h1 style={{ fontFamily:'Cantarell, "Open Sans", "Helvetica Neue", sans-serif',padding,paddingTop:'20px',  fontSize: '24px', marginBottom: '20px' }}>Transaction Value Time Series Forecasting</h1>
      </div>
