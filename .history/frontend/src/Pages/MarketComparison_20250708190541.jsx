...
const MarketComparison = () => {
  ...
  const [selectedDistricts, setSelectedDistricts] = useState(['Beirut', 'El Metn']); // Start with two defaults
  ...
  const handleCompare = async () => {
    ...
    try {
        console.log(`Simulating API call: GET /compare?${params.toString()}`);
