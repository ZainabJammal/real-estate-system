...
const MarketComparison = () => {
  const [selectedDistricts, setSelectedDistricts] = useState(['Beirut', 'El Metn']); // Start with defaults
  ...
  const handleCompare = async () => {
    ...
    try {
        // Use your actual backend URL (e.g., http://127.0.0.1:8000/api/compare)
        const response = await fetch(`http://127.0.0.1:8000/api/compare?${params.toString()}`);
