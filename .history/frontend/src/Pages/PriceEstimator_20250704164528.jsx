...
const PriceEstimator = () => {
  ...
  useEffect(() => {
    ...
    const staticConfig = {
      provinces: { 'Beirut': { districts: ['Beirut'] }, 'Mount Lebanon': { districts: ['El Metn', 'Kesrouane', 'Jbeil', 'Baabda',  'Chouf'] }, 'North': { districts: ['Batroun', 'Tripoli', 'Koura', 'Zgharta'] }, 'South': { districts: ['Saida', 'Jezzine', 'Tyre'] }, 'Bekaa': { districts: ['Zahle', 'Baalbeck', 'Rashaya'] }, 'Nabatieh': { districts: ['Nabatieh', 'Hasbaya', 'Marjeyoun'] }, },
