...
const CurrentPriceEstimation = () => {
  ...
  useEffect(() => { 
    if (options) {
      ...
      if (!selectedBedrooms && options.bedroom_options?.length > 0) setSelectedBedrooms(String(options.bedroom_options?.sort((a,b) => a - b)[0].map)); // Sort to get the lowest number
