...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ display: 'wrap', alignItems: 'center', padding: '20px', width: '100%', borderRadius: '5px' }}>
      ...
      <section style={{ height: '400px', overflow: 'hidden', flexDirection: 'row',  }}>
        ...
        <div className="form-group" style={{paddingLeft: '60px'}} >
          <label htmlFor="granularity">Time Unit:</label>
          <select style={{ backgroundColor:'#2C3E50',padding: '8px', fontWeight: '400', color:'white',
              marginLeft: '20px',
              height: '40px',
              width: '154px' }} id="granularity" value={granularity} onChange={(e) => setGranularity(e.target.value)}>
