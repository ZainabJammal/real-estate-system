...
const CurrentPriceEstimation = () => {
  ...
  const [selectedType, setSelectedType] = useState( "Restaurant",    "Gas Station", "Residential Building", "Office", "Factory", "House/Villa", "Chalet", "Commercial Building", "Warehouse", "Apartment", "Shop", "Land");
