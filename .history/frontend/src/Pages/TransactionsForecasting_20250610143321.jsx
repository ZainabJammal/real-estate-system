...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ maxWidthmarginBottom: '20px', display: 'flex', flexWrap: 'wrap', gap: '15px', alignItems: 'center', padding: '10px', border: '1px solid #ccc', borderRadius: '5px' }}>
