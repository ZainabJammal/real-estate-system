...
const CurrentPriceEstimation = () => {
  ...
  return (
    <div className="price-estimation-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ marginBottom: '20px', padding: '15px', width: '100%', border: '1px solid #ccc', borderRadius: '5px' }}>
        ...
        <button
          ...
          style={{ position: 'relative', marginTop: '20px', padding: '10px 20px', cursor: (isLoadingPrice || !selectedDistrict || !selectedType) ? 'not-allowed' : 'pointer' }}
        >
