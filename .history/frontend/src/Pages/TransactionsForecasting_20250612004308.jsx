...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      <div></div><h1 style={{ fontFamily:'Cantarell, "Open Sans", "Helvetica Neue", sans-serif', fontSize: '24px', marginBottom: '20px' }}>Transaction Value Time Series Forecasting</h1>
