...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ display: 'wrap', alignItems: 'center', padding: '20px', width: '100%', borderRadius: '5px' }}>
      ...
      <section style={{ height: '400px', overflow: 'auto' }}><form onSubmit={handleSubmit} style={{ flex: '1', display: 'flex', borderRadius:'5px', border: '1px solid var(--background-light-gray-f)',
         width:'100%', height:'400hv', fontSize:'20px'}}>
