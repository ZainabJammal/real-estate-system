...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ display: 'wrap', alignItems: 'center', padding: '20px', width: '100%', borderRadius: '5px' }}>
      ...
      <section style={{ height: '400px', overflow: 'hidden', justifyContent:'center' }}>
        <form onSubmit={handleSubmit} style={{ paddingTop:'',flex: '1', display: 'flex', borderRadius:'5px', border: '1px solid var(--background-light-gray-f)',
