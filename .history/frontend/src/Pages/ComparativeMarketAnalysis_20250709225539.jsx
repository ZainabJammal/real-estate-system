...
import './ComparativeMarketAnalysis.css'; // You'll need to create/update this CSS file
...
const MarketComparison = () => {
  ...
  const [selectedDistricts, setSelectedDistricts] = useState(['', '']); // Start with two defaults
...
export default Comparative Market Analysis;