...
const TimeSeriesForecasting = () => {
  ...
  const {
    ...
    queryKey: ['transaction_lstm_predictions', selectedCity, granularity, periods],
    queryFn: () => {
      // FIX: Ensure a city is selected before fetching
      if (!selectedCity) return Promise.resolve(null);
      return fetchTransactionPredictions(selectedCity, granularity, periods);
    },
    enabled: false,
    retry: false,
  ...
  return (
    <div className="prediction-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <form onSubmit={handleSubmit} style={{ /* ... your form styles are fine ... */ }}>
        ...
        {/* Bonus: Add an input for the number of periods to forecast */}
        <div className="form-group">
