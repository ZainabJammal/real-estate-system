...
const CurrentPriceEstimation = () => {
  ...
  return (
    <div className="price-estimation-container" style={{ padding: '20px', fontFamily: 'Arial, sans-serif', width: '100%', maxWidth: '800px' }}>
      ...
      <form onSubmit={handleSubmit} style={{ marginTop:'25px',marginBottom: '20px', padding: '15px', width: '100%', border: '1px solid #ccc', borderRadius: '5px' }}>
        ...
        <div style={{ display: 'flex', alignContent: 'flex', marginTop: '' }}>
          <div>
              {selectedType !== "Land" && (
                <div style={{ paddingTop: '10px', display: "flex", gap: "1rem" }}>
          ...
          <button
            ...
            style={{  marginTop: '20px', paddingRight: '10px 20px', cursor: (isLoadingPrice || !selectedDistrict || !selectedType) ? 'not-allowed' : 'pointer' }}
          >
