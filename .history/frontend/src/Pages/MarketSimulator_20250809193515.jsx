...
const MarketSimulator = () => {
    ...
    return (
      ...
      <div className="market-simulator-content">
        <div className="market-simulator-title" style={{ fontSize: '20px !important' }}>
          ...
          <form onSubmit={handleSubmit}>
             <div className="form-group">
              ...
              <div className="form-group">
                ...
                <select id="scenario" value={selectedScenario} onChange={(e) => setSelectedScenario(e.target.value)}>
              ...
              <button type="submit" style={{ padding: '8px 12px' }}>Get Forecast</button>
            </form>
