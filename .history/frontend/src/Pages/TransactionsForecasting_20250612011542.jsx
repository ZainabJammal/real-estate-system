...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" style={{ display: 'wrap', alignItems: 'center', padding: '20px', borderRadius: '5px' }}>
      ...
      <form onSubmit={handleSubmit} style={{ flex: '1', display: 'flex', borderRadius:'5px', border: '1px solid var(--background-light-gray-f)',
          fontSize:'20px'}}>
        <div className="form-group" style={{ display: 'flex', flexDirection: 'column', paddingRight: '20px' }}>
