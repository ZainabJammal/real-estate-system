...
import './MarketComparison.css'; // We'll create this CSS file for styling
...
const MarketComparison = () => {
  ...
  useEffect(() => {
    ...
    const districtsFromData = [
      "Beirut", "El Metn", "Kesrouane", "Jbeil", "Baabda", "Aley", "Chouf",
      "Batroun", "Koura", "Zgharta", "Nabatieh", "Hasbaya", "Bekaa", "Zahle"
    ].sort();
  ...
  return (
    <div className="comparison-page">
      ...
      <p className="subtitle">Select two or more districts to compare them side-by-side.</p>
