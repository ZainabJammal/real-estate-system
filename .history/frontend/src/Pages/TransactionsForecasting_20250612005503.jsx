...
const TimeSeriesForecasting = () => {
  ...
  return (
    <div className="prediction-container" >
      <div><h1 style={{ fontFamily:'Cantarell, "Open Sans", "Helvetica Neue", sans-serif', fontSize: '24px', marginBottom: '20px' }}>Transaction Value Time Series Forecasting</h1>
      </div>
      <section><form onSubmit={handleSubmit} style={{ flex: '1', display: 'flex', borderRadius:'5px', border: '1px solid var(--background-light-gray-f)',
        ...
        <div className="form-group">
          <label htmlFor="selectedCity" style={{ paddingRight: '10px', paddingLeft: '10px', fontSize: '20px', fontFamily:'Cantarell, "Open Sans", "Helvetica Neue", sans-serif' }}>City:</label>
          <select
            id="selectedCity"
            value={selectedCity}
