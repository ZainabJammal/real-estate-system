...
# --- Basic Setup ---
load_dotenv()
OUTPUT_DIR = os.path.join(os.getcwd(), 'timeseries_models')
...
if __name__ == "__main__":
    ...
    param_grid = {
        'colsample_bytree': [0.8, 0.9, 1.0], 'max_depth': [3, 5, 7],
        'learning_rate': [0.01, 0.05, 0.1], 'n_estimators': [100, 200, 300],
        'subsample':  [0.8, 0.9, 1.0], 'reg_alpha': [0, 0.1, 1, 10],
        'reg_lambda': [0, 0.1, 1, 10], 'gamma': [0, 0.1, 0.2],
