...
def load_all_artifacts():
    ...
    try:
        ...
        ML_artifacts['model_apartment'] = joblib.load(os.path.join(PRICE_MODEL_DIR, 'model_apartment.joblib'))
        ML_artifacts['model_general_fallback'] = joblib.load(os.path.join(PRICE_MODEL_DIR, 'model_general_fallback.joblib'))
        ML_artifacts['kmeans_model'] = joblib.load(os.path.join(PRICE_MODEL_DIR, 'kmeans_model.joblib'))
        ...
        if os.path.exists(office_model_path):
            ML_artifacts['model_office'] = joblib.load(office_model_path)
        if os.path.exists(shop_model_path):
            ML_artifacts['model_shop'] = joblib.load(shop_model_path)
...
@ml_routes.route("/predict_property" \
"" \
"", methods=["POST"])
