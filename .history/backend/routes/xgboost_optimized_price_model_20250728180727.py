...
def prepare_apartment_data(df):
    ...
    # --- (Existing Cleaning Code: Keep as is) ---
    ...
    beirut_cbd = (33.895, 35.509) # Approx. coordinates for Martyrs' Square
    ...
    df_apartments_clean['bed_bath_ratio'].replace([np.inf, -np.inf], np.nan, inplace=True) # Handle division by zero
