...
def setup_environment():
    ...
    # Now, build the paths relative to the `backend_dir`
    output_dir = os.path.join(backend_dir, 'final_model_output_')
    data_path = os.path.join(backend_dir, 'properties.csv')
...
def prepare_apartment_data(df):
    ...
    labels = ['Studio/Small (0-80m²)', 'Standard (81-120m²)', 'Comfortable (121-180m²)', 'Large (181-250m²)', 'Very Large (251-400m²)', 'Penthouse (401m²+)']
