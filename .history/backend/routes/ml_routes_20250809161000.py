...
BACKEND_DIR = os.path.dirname(ROUTES_DIR)
MODEL_PATH = os.path.join(BACKEND_DIR, 'forecasting_models')
# XGB_MODEL = os.path.join(MODEL_PATH, 'xgboost_model.joblib')
# MODEL_COLS_PATH = os.path.join(BACKEND_DIR, 'model_columns.json')
...
XGB_MODEL_COLS_PATH = os.path.join(BACKEND_DIR, 'model_columns.json')
# XGB_MODEL_COLS = list(pd.read_json(XGB_MODEL_COLS_PATH, typ='series'))
