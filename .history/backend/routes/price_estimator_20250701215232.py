...
#         ('imputer', SimpleImputer(strategy='median')), # Use median to fill missing room counts
#         ('scaler', StandardScaler())
#     ])
#     categorical_transformer = OneHotEncoder(handle_unknown='ignore', sparse_output=False)

#     # Use a list to dynamically build transformers based on feature_config
#     transformers = []
#     if 'numerical' in feature_config and feature_config['numerical']:
#         transformers.append(('num', numeric_transformer, feature_config['numerical']))
#     if 'room' in feature_config and feature_config['room']:
#         transformers.append(('room', room_transformer, feature_config['room']))
#     if 'categorical' in feature_config and feature_config['categorical']:
#         transformers.append(('cat', categorical_transformer, feature_config['categorical']))
