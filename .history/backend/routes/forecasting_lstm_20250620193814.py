...
if __name__ == "__main__":
    ...
    # 1. First, separate the target variable ('y') while it's still available.
    city_target_unscaled = city_full_history_df[TARGET_COL]
    
    # 2. Now, prepare the feature set ('X') by re-indexing to match the model's training columns.
    ...
    all_data_final = all_data_final_raw.reindex(columns=FEATURES, fill_value=0) # Align columns just in case
