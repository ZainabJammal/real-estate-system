...
try:
    ...
    # ...and assumes the main project folder is the one containing the folder where this script lives.
    # If ml_routes.py is in /backend/routes/, then SCRIPT_DIR is /backend/routes/, and BACKEND_DIR becomes /backend/
    BACKEND_DIR = os.path.dirname(SCRIPT_DIR)
except NameError:
    # A fallback for interactive testing if __file__ is not defined
