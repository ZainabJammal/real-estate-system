...
#     artifacts = {}
#     try:
#         print("--- Loading Price Estimation Models and Artifacts ---")
#         print(f"Searching for models in: {PRICE_MODEL_DIR}")
...
#         # Safely load specialist models only if they exist
#         specialist_types = ['apartment', 'office', 'shop']
#         for prop_type in specialist_types:
#             model_path = os.path.join(PRICE_MODEL_DIR, f'model_{prop_type}.joblib')
#             if os.path.exists(model_path):
#                 artifacts[f'model_{prop_type}'] = joblib.load(model_path)
#                 print(f"-> Successfully loaded '{prop_type}' specialist model.")
#             else:
#                 print(f"-> NOTE: Specialist model for '{prop_type}' not found. It will use the fallback.")
        
#         print("--- Price Estimation Artifacts Loaded Successfully ---")
#         return artifacts

#     except FileNotFoundError as e:
#         print(f"FATAL ERROR: Could not load a required model file. {e}")
#         print("Please ensure the training script has been run and the 'final_models' directory is correctly placed.")
#         return None
    
# ML_ARTIFACTS = load_price_artifacts()
...
XGB_MODEL_COLS = list(pd.read_json(MODEL_COLS_PATHfrd cx, typ='series'))
