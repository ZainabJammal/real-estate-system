...
# CSV_FILE_PATH = os.path.join(ROOT_DIR,'Schema', 'transactions.csv')
# MAPPING_FILE_PATH = os.path.join(ROOT_DIR, 'region_mapping.json') # Path to our new mapping file
# MODEL_FILE_PATH = os.path.join(ROOT_DIR,'models', 'forecast_model.joblib')
# MODEL_COLS_PATH = os.path.join(ROOT_DIR,'models', 'model_columns.json')

PROJECT_ROOT_DIR = os.path.dirname(os.path.dirname(SCRIPT_DIR))

# Define all your paths relative to the project root and their dedicated folders
CSV_FILE_PATH = os.path.join(PROJECT_ROOT_DIR, 'Schema', 'transactions.csv')
MAPPING_FILE_PATH = os.path.join(PROJECT_ROOT_DIR, 'mapping file', 'region_mapping.json')
MODEL_FILE_PATH = os.path.join(PROJECT_ROOT_DIR, 'models', 'forecast_model.joblib')
MODEL_COLS_PATH = os.path.join(PROJECT_ROOT_DIR, 'models', 'model_columns.json')
# ...
...
if __name__ == "__main__":
    ...
    region_to_plot = 'Beirut' # Use the name from your JSON file
