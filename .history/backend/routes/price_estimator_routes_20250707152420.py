...
def init_price_estimator_routes(model_dir):
    ...
    try:
        ...
        traceback.print_exc()
        # PIPELINE will remain None, and the endpoint will fail gracefully.

    # After loading (or failing to load), we return the blueprint object itself.
    # The routes are already attached to it below.
