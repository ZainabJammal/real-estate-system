...
def setup_environment():
    ...
    # output_dir = os.path.join(os.getcwd(), 'price_model_output')
    ...
    print(f"-> Model artifacts will be saved to: '{os.path.abspath(outp)}'")
    print("="*60)
    return output_dir
...
def main():
    ...
    df_raw.drop_duplicates(subset=['id'], inplace=True); df_raw.rename(columns={'type': 'type'}, inplace=True)
