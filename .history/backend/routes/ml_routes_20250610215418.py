...
model_path = os.path.join(backend_dir, train_master_transaction_model.h5")
features_path = os.path.join(backend_dir, "model_features.json")

print(f"DEBUG: Loading model from: {model_path}")
print(f"DEBUG: Loading features from: {features_path}")

MASTER_MODEL = load_model(model_path)
with open(features_path, 'r') as f:
    MODEL_FEATURES = json.load(f)

print("Master model and features loaded successfully.")
