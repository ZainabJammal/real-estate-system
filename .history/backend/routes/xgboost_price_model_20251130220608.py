...
def prepare_apartment_data(df):
    ...
    df_apartments_clean.replace([np.inf, -np.inf], np.nan, inplace=True) 

    # 2. Location-based Aggregate Features
...
def plot_correlation_heatmap(df, output_dir):
    ...
    corr_cols = ['price_$', 'size_m2', 'bedrooms', 'bathrooms', 'latitude', 'longitude',
                 'avg_size_in_district','avg_price_in_district',  'price_per_m2', 
                   'size_per_bedroom', 'bed_bath_ratio']
