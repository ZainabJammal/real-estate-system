...
# --- (SETUP and DATA LOADING sections remain exactly the same) ---
# ... (load_dotenv, supabase client, blueprint definition, fetch_and_prepare_all_data) ...
# ... (ALL_SYNTHETIC_DATA cache, map_user_selection_to_city) ...

# --- SCENARIO GENERATION FUNCTIONS (ENHANCED LOGIC) ---
