...
async def forecast_with_xgboost(user_selection: str):
    ...
    try:
        ...
        # Step A: Fetch historical data (still needed for yoy_growth)
        ...
        # Step C: Combine and create features for the future
        ...
        features_for_pred = combined_features.loc[future_df.index] # Select only future rows
        features_encoded = pd.get_dummies(features_for_pred, columns=[GROUPING_KEY])
        ...
        # ... (the rest of your JSON formatting logic remains the same) ...
