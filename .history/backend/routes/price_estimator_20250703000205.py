...
# --- 1. SETUP & CONFIGURATION (CORRECTED) ---
def setup_environment():
    ...
    # Now, build the output path relative to the `backend_dir`
    ...
    # We no longer need data_path, but we return output_dir
    return output_dir

# --- (The rest of your functions are mostly perfect) ---
...
def main():
    ...
    # Step 1.5: Load data FROM SUPABASE
