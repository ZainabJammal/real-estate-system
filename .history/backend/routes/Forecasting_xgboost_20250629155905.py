...
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
# 2. Go one level up to get the main 'backend' directory
BACKEND_DIR = os.path.dirname(SCRIPT_DIR)
# 3. Define the final, correct output directory
...
# # *** CHANGE 1: Define the new output directory ***
# SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
# OUTPUT_DIR = os.path.join(SCRIPT_DIR, 'forecasting_models') 

# # *** CHANGE 2: Update file paths to use the new directory ***
# MODEL_FILE_PATH = os.path.join(OUTPUT_DIR, 'forecast_model.joblib')
# MODEL_COLS_PATH = os.path.join(OUTPUT_DIR, 'model_columns.json')
...
#     # *** CHANGE 3: Create the output directory if it doesn't exist ***
#     if not os.path.exists(OUTPUT_DIR):
#         os.makedirs(OUTPUT_DIR)
#         print(f"-> Created directory: '{OUTPUT_DIR}'")
