...
train_totals = all_historical_data[all_historical_data['city'] == USER_CHOICE_CITY].groupby('date')['transaction_value'].sum()
test_totals = all_historical_data[all_historical_data['city'] == USER_CHOICE_CITY].groupby('date')['transaction_value'].sum()
predicted_totals = monthly_forecast.groupby('date')['predicted_value'].sum()
