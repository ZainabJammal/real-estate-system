...
DYNAMIC_RATES = {
    ...
    2024: {'Beirut': {'crash': 0.02, 'boom': 0.15}, 
                'Bekaa': {'crash': 0.03, 'boom': 0.125}, 
                    'Tripoli': {'crash': 0.02, 'boom': 0.135}, 
                        'Baabda': {'crash': 0.03, 'boom': 0.145}, 
                            'Kesrouan': {'crash': 0.04, 'boom': 0.17}},
    2025: {'Beirut': {'crash': 0.03, 'boom': 0.17}, 
                'Bekaa': {'crash': 0.04, 'boom': 0.15}, 
                    'Tripoli': {'crash': 0.03, 'boom': 0.16}, 
                        'Baabda': {'crash': 0.04, 'boom': 0.17}, 
                            'Kesrouan': {'crash': 0.05, 'boom': 0.185}},
}
