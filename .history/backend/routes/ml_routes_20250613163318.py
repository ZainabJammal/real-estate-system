...
CSV_FILE_PATH = os.path.join(SCRIPT_DIR, 'C:\\Users\\user\\Documents\\Real Estate SPF\\real-estate-system\\real-estate-system\\Schema\\transactions.csv') # Assuming the CSV is here
XGB_MODEL_PATH = os.path.join(SCRIPT_DIR, 'C:\\Users\\user\\Documents\\Real Estate SPF\\real-estate-system\\real-estate-system\\backend\\transaction_forecasting\\forecast_model.joblib')
XGB_COLS_PATH = os.path.join(SCRIPT_DIR, 'backend\transaction_forecasting\model_columns.json')
