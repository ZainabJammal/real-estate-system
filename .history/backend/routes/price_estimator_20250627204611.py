...
MODEL_CONFIG = {
    ...
    'land': {   'params': {
        'depth': 6,  # Revert to previous working depth
        'learning_rate': 0.01,
        'l2_leaf_reg': 10,
        'iterations': 2000,
        # Remove feature_weights completely for now
        'grow_policy': 'SymmetricTree',  # Add this
        'min_data_in_leaf': 10  # Add this safety measure
    },
    'features': {
        'numerical': ['log_size_m2'],
        'categorical': ['province', 'district']  # Temporarily remove city
    }
    },
    'house/villa': {
   'params': {
