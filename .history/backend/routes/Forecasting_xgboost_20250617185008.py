...
Traceback (most recent call last):
  File "C:\Users\user\Documents\Real Estate SPF\real-estate-system\real-estate-system\backend\routes\Forecasting_xgboost.py", line 135, in <module>
    plot_validation_results(train_city_df, validation_city_df, city_plot_predictions)
  File "C:\Users\user\Documents\Real Estate SPF\real-estate-system\real-estate-system\backend\routes\Forecasting_xgboost.py", line 58, in plot_validation_results
    plt.plot(validation_df.index, predictions_df, label='Predicted Values (2016)', color='red', linestyle='--')
  File "C:\Users\user\Documents\Real Estate SPF\real-estate-system\real-estate-system\backend\.venv\lib\site-packages\matplotlib\pyplot.py", line 3829, in plot
    return gca().plot(
  File "C:\Users\user\Documents\Real Estate SPF\real-estate-system\real-estate-system\backend\.venv\lib\site-packages\matplotlib\axes\_axes.py", line 1777, in plot
  ...
  File "C:\Users\user\Documents\Real Estate SPF\real-estate-system\real-estate-system\backend\.venv\lib\site-packages\matplotlib\axes\_axes.py", line 1777, in plot
    lines = [*self._get_lines(self, *args, data=data, **kwargs)]
  File "C:\Users\user\Documents\Real Estate SPF\real-estate-system\real-estate-system\backend\.venv\lib\site-packages\matplotlib\axes\_base.py", line 297, in __call__
    yield from self._plot_args(
  File "C:\Users\user\Documents\Real Estate SPF\real-estate-system\real-estate-system\backend\.venv\lib\site-packages\matplotlib\axes\_base.py", line 494, in _plot_args
