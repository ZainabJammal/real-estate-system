...
if __name__ == "__main__":
    try:
        # Use a relative path with forward slashes for better portability
        data_path = "C:/Users/user/Documents/Real Estate SPF/real-estate-system/real-estate-system/Schema/properties.csv"
        model_save_path = "C:/Users/user/Documents/Real Estate SPF/real-estate-system/real-estate-system/backend/models/property_price_model.joblib"
        ...
        print("✅ Model re-trained and saved successfully as 'property_price_model.joblib'")
        
    except FileNotFoundError:
        print(f"❌ CRITICAL ERROR: Could not find the dataset at '{data_path}'. Make sure the path is correct relative to where you run this script.")
