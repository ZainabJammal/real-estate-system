...
def create_features(df):
    ...
    # --- START: NEW FEATURES TO CAPTURE VOLATILITY ---
    # 1. Holiday and High-Season Flags
    ...
    # We can now drop the original 'month' as sin/cos are more powerful
...
if __name__ == "__main__":
    ...
    param_grid = {
        'n_estimators': [500, 1000], 'max_depth':  [3, 5, 7, 10],
