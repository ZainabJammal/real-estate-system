...
CSV_FILE_PATH = os.path.join(SCRIPT_DIR, 'C:\\Users\\user\\Documents\\Real Estate SPF\\real-estate-system\\real-estate-system\\Schema\\transactions.csv')
MODEL_FILE_PATH = os.path.join(SCRIPT_DIR, 'C:\\Users\\user\\Documents\\Real Estate SPF\\real-estate-system\\real-estate-system\\backend\\transaction_forecasting\\forecast_model.joblib')
MODEL_COLS_PATH = os.path.join(SCRIPT_DIR, 'C:\\Users\\user\\Documents\\Real Estate SPF\\real-estate-system\\real-estate-system\\backend\\transaction_forecasting\\model_columns.json')
