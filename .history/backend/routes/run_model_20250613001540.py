...
if __name__ == "__main__":
    ...
    try:
        import pandas, xgboost, joblib, sklearn
    except ImportError:
        print("One or more required libraries (pandas, xgboost, joblib, scikit-learn) are not installed.")
        print("Please run: pip install pandas xgboost joblib scikit-learn")
        exit()
    ...
    USER_CHOICE_CITY = "Beirut"  # You can change this to "Bekaa", "Tripoli, Akkar", etc.
