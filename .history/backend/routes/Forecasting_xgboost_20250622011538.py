...
# --- Step 4: Evaluate and Plot the Validation Results (Using Your Corrected Logic) ---
    ...
    plot_validation_results(
            ...
            region_name=region_to_plot.capitalize() # Pass the name for the title
        )
    else:
        print(f"No validation data found to plot for region '{region_to_plot}'.")

# We also need to slightly modify the plotting function to accept the new 'region_name' argument
