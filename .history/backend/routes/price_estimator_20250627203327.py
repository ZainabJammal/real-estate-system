...
MODEL_CONFIG = {
    ...
    'land': {
    'params': {
        'depth': 3,  # Extremely simple model
        'learning_rate': 0.001,
        'l2_leaf_reg': 30,
        'iterations': 1000,
        'min_data_in_leaf': 30,  # 4% of dataset
        'feature_weights': [('log_size_m2', 3)]  # Force size importance
    },
    'features': {
        'numerical': ['log_size_m2'],
        'categorical': ['province']  # Start with just province
    }
},
    'house/villa': {
    'params': {
        ...
        'learning_rate': 0.005,
        'l2_leaf_reg': 20,
        'one_hot_max_size': 3,  # Reduce cardinality
        'feature_weights': [('log_size_m2', 2), ('bathrooms', 1.5)]
    }
,
        'features': {
            'numerical': ['log_size_m2', 'bedrooms', 'bathrooms'],
...
'chalet': {
    'params': {
        'depth': 3,
        'iterations': 500,
        'min_data_in_leaf': 15,  # 13% of data
        'random_strength': 5  # Maximum randomness
    }
},
        'features': {
            'numerical': ['log_size_m2', 'bedrooms', 'bathrooms'],
