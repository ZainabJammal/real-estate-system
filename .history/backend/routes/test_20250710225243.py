...
p90 = df[df['type'] == 'Apartment']['size_m2'].quantile(0.90)
print(f"90% of apartments in this dataset are smaller than {p90:.2f} m².")

# Find the 99th percentile for apartment sizes
p10 = df[df['type'] == 'Apartment']['size_m2'].quantile(0.10)
print(f"10% of apartments in this dataset are bigger than {p10:.2f} m².")
