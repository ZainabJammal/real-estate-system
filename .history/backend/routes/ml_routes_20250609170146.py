...
# <<< FIX 1: IMPORT YOUR CUSTOM MODEL CLASS >>>
# This makes the class definition available to joblib when it loads the model.
# This line was commented out before. It is now essential.
from .Price_Estimation import EnsemblePropertyPredictor
