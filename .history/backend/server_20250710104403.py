...
from routes.market_comparison import market_comparison 
...
market_comparison_bp = market_comparison.create_market_comparison_bp()
...
app.register_blueprint(market_comparison, url_prefix="/api")
